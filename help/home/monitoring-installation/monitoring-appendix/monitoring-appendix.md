...
## Data Workbench 모니터링 프로필에 사용된 프로필 {#section-b5b1234f55c3407dae8e68b031b7cd7f}
...
상태 프로필을 사용하면 작업 관점에서 Data Workbench가 현재 어떻게 작동하는지 확인할 수 있습니다. 다음 **프로필 상태** 프로필 및 **서버 상태** 프로필은 세부 상태 및 data workbench 서버에서 데이터를 수집합니다. 수집한 모든 데이터는 `cs-uri-query` 사용할 필드입니다.

다음 **내역 프로필** 이전 데이터를 사용하여 구성 및 하드웨어 변경의 영향을 평가할 수 있습니다. 이전 프로필은 시간에 따른 구성 및 하드웨어 변경의 영향을 평가할 수 있으므로 가장 유용할 수 있습니다.
