---
description: Microsoft Windows Server 2000 이상에서 실행 중인 IBM AIX 5.1 이상에서 IBM HTTP 서버를 설치 및 구성하는 방법에 대한 지침입니다.
...
Microsoft Windows Server 2000 이상에서 실행 중인 IBM AIX 5.1 이상에서 IBM HTTP 서버를 설치 및 구성하는 방법에 대한 지침입니다.
...
IBM AIX 서버에서 Sensor 프로그램 파일을 설치할 디렉토리를 만듭니다. 디스크 큐도 이 디렉터리에 있으므로 선택한 장치에 필요한 크기의 큐를 저장할 충분한 공간이 있는지 확인하십시오.
...
## 웹 응용 프로그램에 Collector 추가 {#section-c5b83ae4ebce430aa764f951e849b333}

WebSphere 서버의 경우 컬렉터는 서블릿 컨테이너에서 필터로 작동합니다.

수집기를 웹 앱에 추가하려면 센서에서 캡처하는 이벤트가 있는 웹 서버의 web.xml 파일을 엽니다.
...
## 컬렉터 및 공유 개체 파일의 위치 선언 {#section-b9c298fa645f4670b2503647d967846f}
...
페이지에서 추가 데이터를 캡처하려면 다음을 수행하십시오.
