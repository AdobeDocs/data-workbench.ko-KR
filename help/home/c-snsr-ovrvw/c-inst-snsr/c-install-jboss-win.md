---
description: Microsoft Windows Server 2000 이상에서 실행 중인 JBoss Server 4.0.5 이상 버전용 센서 설치 및 구성에 대한 자세한 지침
...
Microsoft Windows Server 2000 이상에서 실행 중인 JBoss Server 4.0.5 이상 버전용 센서 설치 및 구성에 대한 자세한 지침
...
1. JBoss 서버에서 Sensor 프로그램 파일을 설치할 디렉토리를 만듭니다. 디스크 대기열이 이 디렉토리에 있으므로 선택한 장치에 필요한 크기의 큐를 저장할 충분한 공간이 있는지 확인하십시오.
...
시작 스크립트를 수정하기 전에 JAVA_HOME 변수가 Windows 환경에서 정의되어 있는지 확인합니다.

파일(예: C:\jboss-4.0.5.GA\bin\run.bat)에서 JBoss 서버의 시작 명령 바로 앞에 있는 &quot;echo&quot; 줄 바로 앞에 다음 줄을 추가합니다. [!DNL run.bat]
