---
description: Windows Server 2000 이상에서 실행 중인 Apache Jakarta 4.1 이상 버전의 Sensor 설치 및 구성에 대한 자세한 지침
...
Windows Server 2000 이상에서 실행 중인 Apache Jakarta 4.1 이상 버전의 Sensor 설치 및 구성에 대한 자세한 지침
...
1. Tomcat 서버에서 Sensor 프로그램 파일을 설치할 디렉토리를 만듭니다. 디스크 대기열이 이 디렉토리에 있으므로 선택한 장치에 필요한 크기의 큐를 저장할 충분한 공간이 있는지 확인하십시오.
...
1. bin 폴더에서 Tomcat9w.exe(공용 데몬 서비스 관리자)를 실행합니다.
   ...
   여기서 [!DNL C:\Sensor] 디렉토리는 [!DNL visual_sciences.dll] 파일을 포함하는 디렉토리입니다.
